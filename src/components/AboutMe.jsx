  ...
  return (
    ...
    >
      ...
      <RevealBlock>
        ...
        <h2 className="font-display text-parchment leading-none mb-16 text-[clamp(2.5rem,5vw,5rem)]">
          About Me
        </h2>
      </RevealBlock>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <RevealBlock delay={100}>
          <h3 className="font-display text-gold text-2xl tracking-wider mb-4">
            Myself
          </h3>
          ...
          <p className="text-ash leading-loose text-sm md:text-base mb-8">
            ...
            clean, fast, and user-friendly web experiences. I specialize in
            React.js and Tailwind CSS, crafting scalable components and
            responsive layouts. Currently expanding into full-stack development
            to deliver end-to-end solutions.
          </p>

          <a
            href="#contact"
            className="inline-block bg-gold text-ink text-xs font-medium tracking-widest uppercase px-8 py-4 rounded-sm hover:bg-[#d4b65a] transition-all hover:-translate-y-0.5"
          >
            Get In Touch
          </a>
        </RevealBlock>
        ...
        <RevealBlock delay={200}>
          ...
          <p className="text-ash leading-loose text-sm md:text-base mb-6">
            ...
            graduating with a Second Class Upper (2:1). My foundation in
            programming, data structures, and software engineering shapes my
            approach to building structured applications.
          </p>

          <p className="text-ash leading-loose text-sm md:text-base mb-8">
            I also completed the NYSC program, strengthening my adaptability and
